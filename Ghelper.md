> 查阅文献对于一个科研人员是必备的技能，可经常查阅文献跟踪科研的前沿。谷歌学术(Google Scholar)是非常优秀的科学文献搜索工具。但在国内不能访问谷歌的应用，需要在浏览器中安装谷歌助手(Ghelper)插件来访问。本文就是帮助你安装和使用谷歌助手来访问Google Scholar。
...
## 4. 访问谷歌学术
登录成功后，就可以输入网址：scholar.google.com，使用谷歌学术搜索了。
使用此插件还可以访问谷歌搜索、gmail邮箱等。
>如果不需要使用这个插件，可以到浏览器的设置->Extensions中关闭这个插件。